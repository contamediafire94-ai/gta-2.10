...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Com a Data já instalada, abre direto o launcher principal.
        if (isDataReady()) {
            openServersScreen();
            return;
        }

        // Esta Activity fica apenas responsável pela instalação inicial da Data.
        ...
        new Thread(() -> {
            try {
                ...
                runOnUiThread(() -> {
                    ...
                    Toast.makeText(
                            MainActivity.this,
                            "Data MOD instalada com sucesso.",
                            Toast.LENGTH_SHORT
                    ).show();
                    openServersScreen();
                });
