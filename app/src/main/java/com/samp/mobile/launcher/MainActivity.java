...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        importDialog.setTitle("Importando dados");
        importDialog.setMessage("Copiando texdb...\nIsso pode levar alguns minutos.");
        ...
        new Thread(() -> {
            try {
                ...
                File destination = new File(root, "texdb_app");
                ...
                prefs.edit().putBoolean("texdb_imported", true).apply();
                ...
                runOnUiThread(() -> {
                    ...
                    Toast.makeText(
                            MainActivity.this,
                            "texdb importado com sucesso. Agora pode tocar em JOGAR.",
                            Toast.LENGTH_LONG
                    ).show();
                });
                ...
                runOnUiThread(() -> {
                    ...
                    Toast.makeText(
                            MainActivity.this,
                            "Erro ao importar texdb: " + e.getMessage(),
                            Toast.LENGTH_LONG
                    ).show();
                });
            }
